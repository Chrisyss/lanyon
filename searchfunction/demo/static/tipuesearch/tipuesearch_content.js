...
{
"title"    : "{{ post.title }}{{' written on '}}{{ post.date | date: "%B %d, %Y"}}",
"text"  : "{{ post.content | escape }}",
"tags"     : "{{ post.date | date: "%B %d, %Y"}}  {{post.Tags}}",
"url"      : "{{site.baseurl}}{{'../}}{{posts}}{{   post.url  }}"
...
{% capture Pages %}
{"pages":[
{% for pagers in site.pages %}
{
"title"    : "{{ pagers.title }}", /*{{' written on '}}{{ pagers.date | date: "%B %d, %Y"}}*/
"text"  : "{{ pagers.content | escape }}",
"tags"     : "  {{pagers.Tags}}", /* {{ pagers.date | date: "%B %d, %Y"}}*/
"url"      : "{{site.baseurl}}{{pagerss}}{{   pagers.url  }}"
...
// ---
// ---
// means EVERY FILE IS LIquid parsable!!!!! YES
var tipuesearchBackup = {"pages":[
...
//var tipuesearch = posts.concat(tipuesearchBackup);
//var tipuesearch = tipuesearchBackup;
var Aa = posts.pages;
var Bb = Pages.pages;
//var tipuesearch = {"pages":Bb.concat(Aa)};
//tipuesearch = tipuesearchBackup;
var tipuesearch = {"pages":arrayUnique(Bb.concat(Aa))};
